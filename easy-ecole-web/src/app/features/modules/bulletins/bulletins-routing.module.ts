...
const routes: Routes = [
  ...
  { path: 'parametres-notation', component: ParametresNotationPageComponent },
  { path: 'echelles/nouveau', component: EchelleFormPageComponent },
  { path: 'echelles/:id', component: EchelleFormPageComponent },
  { path: 'deliberations-jury', component: DeliberationsJuryPageComponent },
  ...
  { path: 'absences-cours', component: AbsencesCoursPageComponent },
  { path: 'dettes-academiques', component: DettesAcademiquesPageComponent },
