...
@Component({
  selector: 'app-bordereaux-valides-page',
  templateUrl: './bordereaux-valides-page.component.html',
  styleUrls: ['./bordereaux-valides-page.component.scss']
})
export class BordereauxValidesPageComponent extends BaseComponentClass implements OnInit {
  ...
  private loadBordereaux(): void {
    this.loading = true;
    this.bordereauService.getAll({ statut: 'valide' }).subscribe({
