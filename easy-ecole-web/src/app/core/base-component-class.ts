...
export class BaseComponentClass {
    ...
    rolesValue: RolesValueType = { isApprenant: false, isInstitution: false, isEnseignant: false, isCaissierBanque: false, isPersonnelAdministratif: false, isRessourcesHumaines: false, isCabinetComptable: false, isEsacompta: false, isComiteOrientation: false, isAdmin: false, isParent: false, isSecretaire: false, isSurveillant: false }
    ...
    private getRoles(): void {
        ...
        this.rolesValue = { isApprenant: false, isInstitution: false, isEnseignant: false, isCaissierBanque: false, isPersonnelAdministratif: false, isRessourcesHumaines: false, isCabinetComptable: false, isEsacompta: false, isComiteOrientation: false, isAdmin: false, isParent: false, isSecretaire: false, isSurveillant: false }
        ...
        switch (role) {
            ...
            case RolesUtilisateur.ESA_COMPTA:
                this.rolesValue.isEsacompta = true
                break;

            case RolesUtilisateur.COMITE_ORIENTATION:
                this.rolesValue.isComiteOrientation = true
                break;
            ...
            case RolesUtilisateur.SECRETAIRE:
                this.rolesValue.isSecretaire = true
                break;

            case RolesUtilisateur.SURVEILLANT:
                this.rolesValue.isSurveillant = true
                break;
