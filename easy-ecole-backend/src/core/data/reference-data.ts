...
export const REF_ROLE_PERMISSIONS: RefRolePermission[] = [
  ...
  { roleNom: 'Comptable', permissionKey: 'action.bourse.configuration.creer' },
  { roleNom: 'Comptable', permissionKey: 'action.bourse.configuration.modifier' },
  { roleNom: 'Comptable', permissionKey: 'action.bourse.attribution.creer' },
  { roleNom: 'Comptable', permissionKey: 'action.bourse.attribution.modifier' },
  { roleNom: 'Comptable', permissionKey: 'action.bourse.attribution.suspendre' },
  { roleNom: 'Comptable', permissionKey: 'action.bourse.attribution.reactiver' },
  // ── BOURSES : ESA COMPTA (applique uniquement, ne crée pas les configs) ──
  { roleNom: 'ESA Compta', permissionKey: 'menu.bourses' },
  { roleNom: 'ESA Compta', permissionKey: 'menu.bourses.configurations' },
  { roleNom: 'ESA Compta', permissionKey: 'menu.bourses.attributions' },
  { roleNom: 'ESA Compta', permissionKey: 'menu.bourses.campagne' },
  { roleNom: 'ESA Compta', permissionKey: 'action.bourse.attribution.creer' },
  { roleNom: 'ESA Compta', permissionKey: 'action.bourse.attribution.modifier' },
  { roleNom: 'ESA Compta', permissionKey: 'action.bourse.attribution.suspendre' },
  { roleNom: 'ESA Compta', permissionKey: 'action.bourse.attribution.reactiver' },
  { roleNom: 'ESA Compta', permissionKey: 'action.bourse.campagne.creer' },
