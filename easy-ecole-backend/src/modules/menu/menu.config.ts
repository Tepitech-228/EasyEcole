        ...
        groups: [
            ...
            },
            {
                ...
                items: [
                    ...
                    { label: 'Cours', route: '/cours/cours', icon: 'book', permissionKey: 'menu.cours.liste', allowedRoles: [RolesUtilisateur.INSTITUTION, RolesUtilisateur.ENSEIGNANT, RolesUtilisateur.APPRENANT, RolesUtilisateur.ADMIN] },
