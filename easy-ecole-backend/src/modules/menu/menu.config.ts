        ...
        groups: [
            {
                ...
                items: [
                    ...
                    { label: 'Validation comité', route: '/inscription/comite-validation', icon: 'how_to_reg', permissionKey: 'menu.finances.comite-validation', allowedRoles: [RolesUtilisateur.COMITE_ORIENTATION, RolesUtilisateur.ADMIN] },
                     ...
                     { label: 'Bordereaux en attente', route: '/inscription/finance/bordereaux/en-attente', icon: 'receipt_long', permissionKey: 'menu.finances.bordereaux-a-traiter', allowedRoles: [RolesUtilisateur.ESA_COMPTA, RolesUtilisateur.ADMIN] },
                     { label: 'Bordereaux traités', route: '/inscription/finance/bordereaux/traites', icon: 'receipt_long', permissionKey: 'menu.finances.bordereaux-a-traiter', allowedRoles: [RolesUtilisateur.ESA_COMPTA, RolesUtilisateur.ADMIN] },
                     { label: 'Bordereaux rejetés', route: '/inscription/finance/bordereaux/rejetes', icon: 'receipt_long', permissionKey: 'menu.finances.bordereaux-a-traiter', allowedRoles: [RolesUtilisateur.ESA_COMPTA, RolesUtilisateur.ADMIN] },
