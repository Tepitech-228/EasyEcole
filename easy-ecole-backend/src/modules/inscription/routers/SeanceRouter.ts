...
router
    ...
    .get('/volumes-horaires', SeanceController.getVolumesHoraires)
    .get('/volumes-enseignants', SeanceController.getVolumesEnseignants)
    .get('/retards-enseignants', SeanceController.getRetardsEnseignants)
